...
import theFrontline.vfx.general.CalmFireEffect;
import theFrontline.vfx.general.CasualFlameParticleEffect;

import java.util.ArrayList;

public class SacredEnergyOrb extends CustomEnergyOrb {
    public static final String[] orbTextures = {
            TheFrontline.makeCharPath("orb/layerFake.png"),
            TheFrontline.makeCharPath("orb/layerFake.png"),
            TheFrontline.makeCharPath("orb/layerFake.png"),
            TheFrontline.makeCharPath("orb/layerFake.png"),
            TheFrontline.makeCharPath("orb/layerFake.png"),
    ...
    private static final String VFXTexture = TheFrontline.makeCharPath("orb/EnergyRecharge.png");
