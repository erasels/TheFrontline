...
public class ExhaustionPanel extends AbstractPanel {
    ...
    public ExhaustionPanel() {
        super(96.0F * Settings.scale, 320.0F * Settings.scale, Settings.WIDTH + 480.0F * Settings.scale, Settings.HEIGHT / 2.0f, 12.0F * Settings.scale, -12.0F * Settings.scale, TextureLoader.getTexture(TheFrontline.makeCharPath("orb/vfx.png")), false);
