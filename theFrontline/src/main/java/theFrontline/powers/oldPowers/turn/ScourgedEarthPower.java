...
import static theFrontline.util.UC.doAllDmg;
import static theFrontline.util.UC.p;

public class ScourgedEarthPower extends AbstractFrontlinePower implements CloneablePowerInterface, NonStackablePower {
    public static final String POWER_ID = TheFrontline.makeID("ScourgedEarth");
