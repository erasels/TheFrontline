...
import static theFrontline.TheFrontline.makeCardPath;
import static theFrontline.TheFrontline.makeUIPath;
...
public class TextureLoader {
    ...
    public static Texture getTexture(final String textureString) {
        if (textures.get(textureString) == null) {
            try {
                ...
                return getTexture("theFrontlineResources/images/ui/missing_texture.png");
            }
        }
    ...
    private static void loadTexture(final String textureString) throws GdxRuntimeException {
        logger.info("The Frontline | Loading Texture: " + textureString);
